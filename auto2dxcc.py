...
def main():
    ...
    output_file_path = os.path.join(script_directory, "autodxcc-report.xlsx")

    excel_file_path = os.path.join(script_directory, "callsigns.xlsx")
    if not os.path.isfile(excel_file_path):
        raise FileNotFoundError("callsigns.xlsx not found")
